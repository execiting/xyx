...
function getqrpic(force){
	...
	if(qrsig!=null && qrimg!=null && force==false){
		...
		var getvcurl='https://tool.clwl.online/speed/gamespeed/login.php?do=getqrpic&r='+Math.random(1);
...
function qrlogin(){
	...
	var url = 'https://tool.clwl.online/speed/gamespeed/login.php?do=qrlogin&qrsig='+decodeURIComponent(qrsig)+'&r='+Math.random(1);
	$.get(url, function(d) {
		if(d.saveOK ==0){
